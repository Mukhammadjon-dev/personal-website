...
const Data = () => {
    return(
        <div className="home__data">
            <h1 className="home_title"> Muhammad Nazarov 
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description"> A passionate and detail-oriented frontend developer based in Düsseldorf (Germany)</p>
