...
const Contact = () =>{
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_rncj60i', 'template_2r5lsy3', form.current, {
        publicKey: '_8Y1uoxQ2ic5XVqlK',
      })
      e.target.reset()
  };
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">muhammadjon.nazarov98@gmail.com</span>

                            <a href="muhammadjon.nazarov98@gmail.com" className="contact__button">
                                Write me{" "}
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+491785070268</span>

                            <a href="https://Wa.me/+491785070268" target="_blank" rel="noreferrer" className="contact__button">
                                Write me{" "}
                                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
